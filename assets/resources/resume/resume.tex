...
\begin{itemize}
\item
  \jobtitle{Software Engineer on GKE Security \\ Hardening subteam 2019-2023, Compliance subteam 2023-2025}
  \hspace{\fill}{ {Aug 2019 -- Oct 2025} }
  \workplace{Google, LLC}
  \begin{itemize}
    \vspace{.5em}
  \item\quad Design, implement, and integrate static analysis of the Kubernetes codebase to defend against accidental credential leaks in logs.  See KEP-1993 and CVE-???TODO.
  \item\quad Design and implement engine of automatic test-time analysis of Kubernetes YAML to ensure partner team adherance to security best practices.
  \item\quad Design and implement network-level security protections for the GKE Control Plane, focusing on SSRF prevention.
  \item\quad Unblock \verb!TIER_ONE! customer activation by designing execution plan for key compliance controls, then compressing that plan from 12 months to 3 months when the customer timeline escalated.
  \item\quad Shift evaluation of compliance controls from late-environment monitoring to CL test-time, saving weeks in the engineer feedback cycle for adoption complaince controls.
  \item\quad Participate in oncall rotations, including acting as commander for incoming security events.  Mentor both GKE Security teammates and contribute to Google's Go Readability program.
  \item\quad Received X peer awards, Y of which were specifically due to the high quality of my documentation.
  \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{I wrote a Reddit bot.} I was the author of \href{https://www.reddit.com/user/roll_one_for_me}{\ttt{/u/roll\_one\_for\_me}},
    a table-rolling Reddit bot for \ttt{/r/DnDBehindTheScreen} and related subreddits.
    The bot had been GCP-hosted and deployed via Docker, with source available \href{https://github.com/PurelyApplied/roll_one_for_me/}{on GitHub}.
    (The bot suffered the same fate of many bots, falling to Reddit API changes.)
    
  \item \textbf{I'm really good at pinball.}  At time of writing, I am rated in the top 750 players worldwide, or the top 3\% according to MatchPlay. TODO links.
